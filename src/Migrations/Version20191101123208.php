 ...
 */
final class Version20191101123208 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE vehicle_id vehicle_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE vehicle_id vehicle_id INT DEFAULT NULL');
